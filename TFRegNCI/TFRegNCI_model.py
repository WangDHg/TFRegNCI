...
class merge_model(nn.Module):
    def __init__(self, embed_dim = 16):
        ...
        params = BlockParams.from_init_params(depth=16, w_0=48, w_a=27.89, w_m=2.09,
                                          group_width=8, se_ratio=0.25)
        self.cube_conv = RegNet(block_params=params, stem_width=128, norm_layer=partial(nn.BatchNorm2d, eps=1e-05, momentum=0.1))

        self.aclyr = nn.ReLU()

        self.final1 = nn.Linear(20, 1)
        self.final2 = nn.Linear(48, 16)
